...
(function(){
  ...
  const steps=[
    ...
    {title:'Businesses can fail',body:'A business tracks its own financial balance. If losses reach the original purchase cost, it can enter bankruptcy. Managing costs and watching the economy can help you avoid getting there.',target:'#businessList'},
